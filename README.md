...
|------|------|------|------|
| `openai`         | `OPENAI_API_KEY` | `gpt-5-mini` | [docs](https://platform.openai.com/docs/models) |
| `google`         | `GEMINI_API_KEY` | `gemini-2.5-flash` | [docs](https://ai.google.dev/gemini-api/docs/models/gemini) |
| `anthropic`      | `ANTHROPIC_API_KEY` | `claude-sonnet-4-5-20250929` | [docs](https://docs.anthropic.com/claude/docs/models-overview) |
| `xai`            | `XAI_API_KEY` | `grok-4-fast-reasoning` | [docs](https://docs.x.ai/docs) |
...
| `groq` (not grok)| `GROQCLOUD_API_KEY` | `groq/openai/gpt-oss-120b` | [docs](https://console.groq.com/docs/models) |
...
| `mercury`        | `MERCURY_API_KEY` | `mercury-coder-small` | [docs](https://platform.inceptionlabs.ai/docs#models) |
